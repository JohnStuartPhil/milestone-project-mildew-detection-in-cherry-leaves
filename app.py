...
from app_pages.page_cherry_leaves_visualiser import page_cherry_leaves_visualiser_body
...
app.add_page("Cherry Leaves Visualiser", page_cherry_leaves_visualiser_body)
